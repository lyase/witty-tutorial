...
public:
     GoogleMapExample(Wt::WContainerWidget *parent = 0)
          ...
          Wt::WTemplate *controls =new Wt::WTemplate(tr("graphics-GoogleMap-controls"));
          ...
          Wt::WCheckBox *enableDoubleClickZoomCB =new Wt::WCheckBox("Enable double click zoom");
          ...
          Wt::WCheckBox *enableScrollWheelZoomCB =new Wt::WCheckBox("Enable scroll wheel zoom");
          ...
          map_->doubleClicked().connect(std::bind([=] (Wt::WGoogleMap::Coordinate c) {
